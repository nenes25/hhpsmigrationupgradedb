...
A Docker-based environment is available for testing across multiple PrestaShop and PHP versions.  
See [`_dev/README.md`](_dev/README.md) for setup instructions and usage.
